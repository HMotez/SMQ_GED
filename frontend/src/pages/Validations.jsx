...
/* ── Validation modal — context-aware ─────────────────────── */
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="m-0 text-xs mt-0.5" style={{ color:"rgba(168,191,212,0.48)" }}>
                EF05 — Décisions de validation · Traçabilité complète
                ...
                allHistory.length === 0 ? (
                  ...
                  <div className="rounded-2xl overflow-hidden border"
                    ...
                    {allHistory.map((v, i) => {
                      ...
                      const DI = dcfg.Icon;
                      return (
                        <div key={v.id} className="grid px-5 py-3 items-center transition-all duration-150"
